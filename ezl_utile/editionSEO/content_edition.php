...
class content_edition{
	...
	Public function __construct(){
		...
		$this->optionstype[]='News';		
		$this->optionstype[]='News_de';				
		...
		$this->optionstype[]='Testimony';
		$this->optionstype[]='Technotes';		
		$this->optionstype[]='News';
	...
	Private function checkOtherPOSTValues(){
		...
		if(isset($_POST["update_x"])){	
			...
			$sql="UPDATE eb_articles SET type='$type',produit_hote='$produit_hote',constructeur='$constructeur',typeprod='$typeprod',publi=$publi,ordre='$ordre',url='$url',date_parution='$dtpub' WHERE id='$id'";
//echo 		$sql;exit;	
