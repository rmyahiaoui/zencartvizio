...
(defined('MODULE_PAYMENT_PAYPALWPP_STATUS') ? '' : '... puis cliquez sur "installer" ci-dessus pour activer le support PayPal Express Checkout.</br>') .
...
'<font color="green"><hr /><strong>Pré-requis:</strong></font><br /><hr />*<strong>cURL</strong> est utilisé pour la communication bidirectionnelle avec le portail, il faut donc qu\'il soit actif sur le serveur de votre hébergeur (si vous avez besoin d\'utiliser un proxy cURL, définissez les paramètres du proxy cURL dans Admin->Configuration->My Store.)<br /><hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_EMAIL_ERROR_SUBJECT', 'ALERTE: Erreur PayPal Express Checkout');
  ...
  define('MODULE_PAYMENT_PAYPALWPP_TEXT_BUTTON_ALTTEXT', 'Cliquez ici pour payer par PayPal Express Checkout');
...
////////////////////////////////////////
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_ADDRESS_NAME', 'Adresse 1:');
  define('MODULE_PAYMENT_PAYPAL_ENTRY_ADDRESS_STREET', 'Adresse 1:');
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_EMAIL_ADDRESS', 'E-mail du payeur:');
  ...
  define('MODULE_PAYMENT_PAYPALWPP_ENTRY_PROTECTIONELIG', 'Éligibilité à la protection:');
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_VOID', 'Si vous souhaitez annuler une autorisation, entrez l\'IDentifiant de l\'autorisation ici, puis confirmez:');
...
// this text is used to announce the username/password when the module creates the customer account and emails data to them:
  ...
  define('MODULES_PAYMENT_PAYPALWPP_LINEITEM_TEXT_ONETIME_CHARGES_PREFIX', 'Frais uniques se rapportant ');
