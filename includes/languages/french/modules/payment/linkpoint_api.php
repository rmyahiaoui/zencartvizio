 ...
 */
  ...
  define('ALERT_LINKPOINT_API_PREAUTH_TRANS', '***AUTORISATION UNIQUEMENT -- LE DÉBIT SERA EFFECTUÉ PLUS TARD PAR L\'ADMINISTRATEUR.***');
  define('ALERT_LINKPOINT_API_TEST_FORCED_SUCCESSFUL', 'NOTE: Ceci était une transaction TEST...forcée à renvoyer une réponse ACCEPTÉ.');
  ...
  define('MODULE_PAYMENT_LINKPOINT_API_TRANSACTION_REFERENCE_NUMBER', 'N&deg; Référence: ');
  define('MODULE_PAYMENT_LINKPOINT_API_FRAUD_SCORE', 'Score fraude:');
