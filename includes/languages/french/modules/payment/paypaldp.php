 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPALDP_TEXT_ADMIN_TITLE_WPP', 'Paiement PayPal Pro sur site Web');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_ADMIN_TITLE_PRO20', 'Paiements PayPal Pro sur site Web Édition (FR)');
...
'<font color="green"><hr /><strong>Pré-requis:</strong></font><br /><hr />*<strong>Express Checkout</strong> doit être installé et activé pour utiliser les Paiements Pro sur site Web, comme indiqué dans les conditions du service PayPal.<br /><hr />' );
  ...
  define('MODULE_PAYMENT_PAYPALDP_TEXT_CREDIT_CARD_CHECKNUMBER_LOCATION', '(3 derniers chiffres au dos de votre carte)');
  ...
  define('MODULE_PAYMENT_PAYPALDP_ERROR_AVS_FAILURE_TEXT', 'ATTENTION: Échec de la vérification d\'adresse. ');
  define('MODULE_PAYMENT_PAYPALDP_ERROR_CVV_FAILURE_TEXT', 'ATTENTION: Échec de la vérification du code CVV. ');
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_ADDRESS_STREET', 'Adresse 2: ');
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_EMAIL_ADDRESS', 'E-mail de l\'acheteur: ');
