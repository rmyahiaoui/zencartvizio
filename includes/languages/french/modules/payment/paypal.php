 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPAL_TEXT_ADMIN_TITLE', 'Paiements PayPal Standard sur site Web - IPN');
  ...
  define('MODULE_PAYMENT_PAYPAL_ACCEPTANCE_MARK_TEXT', 'Gangnez du temps. Encaissez en toute sécurité. <br />Payez sans dévoiler vos informations financières.');
  ...
  define('MODULE_PAYMENT_PAYPAL_ENTRY_PAYER_ID', 'ID# payeur: ');
