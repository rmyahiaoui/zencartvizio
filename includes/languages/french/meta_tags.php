...
// page title
define('TITLE',  utf8_encode('Vidéoprojecteur led, pico projecteurs, mini projecteurs. Stock à Paris '));

// Site Tagline
define('SITE_TAGLINE', ' ');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'Vid&eacute;oprojecteur led, pico projecteurs&lt;br&gt;');

// Home Page Only:
define('HOME_PAGE_META_DESCRIPTION',utf8_encode('Trouvez votre vidéoprojecteur led à Paris sur videoprojecteurled.fr. Livraison 24h et économies garanties !'));
