 ...
 */
  ...
  if ( $res->fields['total'] < 1 ) {
    ...
    $sql = "select p.products_id, pd.products_name,
                  ...
                  pd.logiciel_assoc, pd.accessoire_assoc,
                  pd.applic_temoignage, p.products_model,
...
// if review must be approved or disabled do not show review
  ...
  $productsAvantages = $product_info->fields['avantages'];
  $productsCaracTech = $product_info->fields['carac_technique'];
  $productsLogiAssoc = $product_info->fields['logiciel_assoc'];
  $productsAccesAssoc = $product_info->fields['accessoire_assoc'];
  $productsAppliAssoc = $product_info->fields['applic_temoignage'];
...
// var_dump($template->get_template_dir($tpl_page_body,DIR_WS_TEMPLATE, $current_page_base,'templates'). $tpl_page_body);
