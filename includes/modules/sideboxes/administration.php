...
//    $random_specials_sidebox_product = zen_random_select($random_specials_sidebox_product_query);
    ...
    if ($random_specials_sidebox_product->RecordCount() > 0)  {
      require($template->get_template_dir('tpl_administration.php',DIR_WS_TEMPLATE, $current_page_base,'sideboxes'). '/tpl_administration.php');
      // $title =  BOX_HEADING_SPECIALS;
      $title =  '<p style="margin-top:-6px;"><span style="font-size:0.8em">Administration /<br/> Grand compte</span></p>';
