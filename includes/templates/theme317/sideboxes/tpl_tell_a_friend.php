 ...
 */
  ...
  $content .= zen_draw_input_field('to_email_address', '', 'size="22"') . '&nbsp;' . zen_image_submit(BUTTON_IMAGE_TELL_A_FRIEND, BUTTON_TELL_A_FRIEND_ALT) . zen_draw_hidden_field('products_id', $_GET['products_id']) . zen_hide_session_id() . '<br />' . BOX_TELL_A_FRIEND_TEXT;
  $content .= "</form>";
  $content .= '</div>';
?>