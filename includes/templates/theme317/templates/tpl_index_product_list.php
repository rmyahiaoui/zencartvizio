...
<!-- <h1 id="productListHeading">
  <span class="title-left-bg">
    <span class="title-right-bg" style="color:#0299d4;font-size:0.8em;"> --><?php // echo $breadcrumb->last(); ?><!--</span>
  </span>
</h1> -->
...
?>
<!-- <div id="indexProductListCatDescription" class="content" style="font-family:tahoma"> --><?php  
// echo $current_categories_description; 
 ?><!-- </div> -->
...
//   $form = '<div style="border:1px solid #e2e2e2;height:38px;background-image:url(images/tbi_images/page_prod/fond_barre.png);padding-left:10px;padding-top:5px">'.zen_draw_form('filter', zen_href_link(FILENAME_DEFAULT), 'get') . '<label class="inputLabel"> ' .TEXT_SHOW . ' </label> ';
// ?>
...
//   if ($do_filter_list) {
//     echo zen_draw_pull_down_menu('filter_id', $options, (isset($_GET['filter_id']) ? $_GET['filter_id'] : ''), 'onchange="this.form.submit()"').'</div>';
//   }
