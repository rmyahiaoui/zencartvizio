...
<h1 id="indexCategoriesHeading"><span class="title-left-bg"><span class="title-right-bg"><?php echo HEADING_TITLE; ?></span></span></h1>
...
<?php } else { ?>
<h1 id="indexCategoriesHeading"><span class="title-left-bg"><span class="title-right-bg"><?php echo $breadcrumb->last(); ?></span></span></h1>
<?php } ?>
