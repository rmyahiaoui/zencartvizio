...
<h1 id="addressBookProcessDefaultHeading"><span class="title-left-bg"><span class="title-right-bg"><?php if (isset($_GET['edit'])) { echo HEADING_TITLE_MODIFY_ENTRY; } elseif (isset($_GET['delete'])) { echo HEADING_TITLE_DELETE_ENTRY; } else { echo HEADING_TITLE_ADD_ENTRY; } ?></span></span></h1>
