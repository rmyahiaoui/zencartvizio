...
<h1 id="loginDefaultHeading"><span class="title-left-bg"><span class="title-right-bg"><?php echo HEADING_TITLE; ?></span></span></h1>
...
<label class="inputLabel" for="login-password"><?php echo ENTRY_PASSWORD; ?></label>
<?php echo zen_draw_password_field('password', '', zen_set_field_length(TABLE_CUSTOMERS, 'customers_password') . ' class="form-control" '); ?>
<br class="clearBoth" />
<?php echo zen_draw_hidden_field('securityToken', $_SESSION['securityToken']); ?>
</fieldset>
...
<fieldset>
<legend><h5 style="color:#308ce8"><?php echo strtoupper(HEADING_NEW_CUSTOMER); ?></h5></legend>
...
<div class="buttonRow forward"><br/><input type="submit" class="btn btn-success" value="Envoyer le formulaire"/></div><br/><br/>
</form>
<!--EOF normal login-->
<?php } ?>
</div>