...
//                . IH_NEW_NAME_COPY_IMAGES . '<br />'
    ...
    case 'layout_delete':
      ...
      $contents = array('form' => zen_draw_form('image_deletion', FILENAME_IMAGE_HANDLER, 'products_filter=' . $_GET['products_filter'] . '&amp;action=delete' . $imgStr, 'post', '', true));
      ...
      if ($selected_image_suffix == '') {
        $contents[] = array('text' => zen_draw_checkbox_field('delete_from_db_only', 'Y') . IH_DELETE_FROM_DB_ONLY);
      }
      $contents[] = array('align' => 'center', 'text' => '<br />' . zen_image_submit('button_delete.gif', IMAGE_DELETE));
      break;
    default:
      // show new button      
