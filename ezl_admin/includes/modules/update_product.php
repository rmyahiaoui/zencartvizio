...
if ($_POST['image_delete'] == 1) {
    ...
    for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
      ...
      $sql_data_array = array('products_name' => zen_db_prepare_input($_POST['products_name'][$language_id]),
                              ...
                              'avantages' => zen_db_prepare_input($_POST['avantages'][$language_id]),
                              'carac_technique' => zen_db_prepare_input($_POST['carac_technique'][$language_id]),
                              'logiciel_assoc' => zen_db_prepare_input($_POST['logiciel_assoc'][$language_id]),
                              'accessoire_assoc' => zen_db_prepare_input($_POST['accessoire_assoc'][$language_id]),
                              'applic_temoignage' => zen_db_prepare_input($_POST['applic_temoignage'][$language_id]),
