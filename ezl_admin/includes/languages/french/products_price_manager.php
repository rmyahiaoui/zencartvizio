...
define('TEXT_INFO_MASTER_CATEGORIES_CURRENT', 'L\'ID# de la catégorie en cours %s correspond à l\'ID# de la catégorie maître %s');
define('TEXT_INFO_MASTER_CATEGORIES_ID_UPDATE_TO_CURRENT', 'Actualiser l\'ID# de catégorie maître %s pour qu\'il corresponde à l\'ID# de la catégorie en cours %s');
