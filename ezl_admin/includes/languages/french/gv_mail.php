...
define('TEXT_SINGLE_EMAIL', '<span class="smallText">Pour envoyer des e-mails uniques, autrement utilisez le menu déroulant ci-dessus.</span>');
...
define('TEXT_TO_REDEEM', 'Pour utiliser ce ' . TEXT_GV_NAME . ', veuillez cliquer sur le lien ci-dessous. Conservez aussi soigneusement votre ' . TEXT_GV_REDEEM);
...
define('TEXT_CLICK_TO_REDEEM','Cliquez ici obtenir le remboursement');
