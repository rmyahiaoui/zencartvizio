...
define('WARNING_MODULES_SORT_ORDER','AVERTISSEMENT : VOUS AVEZ DES NUMÉROS DE CLASSEMENT EN DOUBLE QUI PRODUIRONT DES ERREURS DE CALCUL&lt;br /&gt;VEUILLEZ CORRIGER CES INFORMATIONS MAINTENANT !');
...
define('TEXT_WARNING_SSL_EDIT', 'ALERTE: <a href="http://tutorials.zen-cart.com/index.php?article=14" target="_blank">Pour des raisons de sécurité, la modification de ce module est désactivée jusqu\'à ce que votre Admin soit configurée pour SSL</a>.');
define('TEXT_WARNING_SSL_INSTALL', 'ALERTE: <a href="http://tutorials.zen-cart.com/index.php?article=14" target="_blank">Pour des raisons de sécurité, l\'installation de ce module est désactivée jusqu\'à ce que votre Admin soit configurée pour SSL</a>.')
?>