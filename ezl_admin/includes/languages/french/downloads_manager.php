...
define('HEADING_TITLE','Downloads');
...
define('TEXT_INFO_HEADING_EDIT_PRODUCTS_DOWNLOAD', 'Édition des informations du download');
define('TEXT_INFO_HEADING_DELETE_PRODUCTS_DOWNLOAD', 'Confirmation de la suppression du download');
define('TEXT_INFO_EDIT_INTRO', 'Modifier les informations du download:');
