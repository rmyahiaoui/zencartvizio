...
//
  ...
  //Details section
  define('HEADING_DEATILS_CUSTOMER_REGISTRATION_TITLE', 'Détails de l\'inscription client PayPal');
  define('HEADING_DETAILS_REGISTRATION_TITLE', 'Notifications de Paiement Instantané PayPal');
  ...
  define('ENTRY_CART_ITEMS', 'Nb de produits dans panier');
