...
define('TEXT_INFO_PRODUCTS_TO_CATEGORIES_AVAILABLE', 'Catégories disponibles pour un lien ...');

define('TABLE_HEADING_PRODUCTS_ID', 'ID Produit');
define('TABLE_HEADING_PRODUCT', 'Nom produit');
define('TABLE_HEADING_MODEL', 'Modèle');
define('TABLE_HEADING_ACTION', 'Action');

define('TEXT_INFO_HEADING_EDIT_PRODUCTS_TO_CATEGORIES', 'ÉDITER LES INFORMATIONS PRODUIT À CATÉGORIES');
...
define('TEXT_INFO_LINKED_TO_COUNT', '&nbsp;&nbsp;Nombre de catégories liées en cours: ');
...
define('WARNING_COPY_ALL_PRODUCTS_TO_CATEGORY_FROM_LINKED', 'Liaison de produits depuis une catégorie invalide: ');
...
define('SUCCESS_COPY_ALL_PRODUCTS_TO_CATEGORY_FROM_LINKED', 'Liaison de produits depuis une catégorie valide: ');
...
define('WARNING_REMOVE_ALL_PRODUCTS_TO_CATEGORY_FROM_LINKED', 'Suppression de produits liés depuis une catégorie invalide: ');
...
define('SUCCESS_REMOVE_ALL_PRODUCTS_TO_CATEGORY_FROM_LINKED', 'Suppression de produits liés depuis une catégorie valide: ');
...
define('WARNING_MASTER_CATEGORIES_ID_CONFLICT', '<strong>ATTENTION: ID DE CATÉGORIE MAÎTRE EN CONFLIT !!</strong>');
...
define('WARNING_MASTER_CATEGORIES_ID_CONFLICT_FIX', 'Pour solutionner ce conflit, vous avez été redirigé(e) vers le premier produit du conflit. Ré-assignez l\'ID de catégorie maître afin qu\'il ne soit plus l\'ID de catégorie maître du produit pour la catégorie depuis laquelle vous essayez de le supprimer, et recommencez. Lorsque tous les conflits ont été corrigés, vousn pourrez alors terminer la suppression que vous souhaitez réaliser.');
define('TEXT_MASTER_CATEGORIES_ID_CONFLICT_FROM', ' Conflit depuis catégorie: ');
