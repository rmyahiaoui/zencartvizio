...
define('TEXT_OK_TO_DELETE', 'Cette option n\'est liée à aucun produit ou valeur - Vous pouvez la supprimer sans risque.<br />AVERTISSEMENT: Toutes les valeurs d\'option seront supprimées avec ce nom d\'option.');
...
define('ERROR_OPTION_VALUES_NONE', 'ERREUR - Copie depuis un nom d\'option qui ne contient aucune valeur définie. Rien n\'a été copié ! ');
...
define('TEXT_OPTION_ATTIBUTE_MAX_LENGTH', '<strong>Longueur max et taille affichée seulement pour les attributs texte:</strong><br />');
