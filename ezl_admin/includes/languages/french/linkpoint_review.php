...
define('HEADING_TITLE', 'Compte-rendu de carte de crédit');
...
define('TEXT_DATE_ACCOUNT_LAST_MODIFIED', 'Dérniere modification:');
...
define('PLEASE_SELECT', 'Choisissez en un seul');
define('TEXT_INFO_NUMBER_OF_ORDERS', 'Nombres de commandes:');
define('TEXT_INFO_LAST_ORDER','Dérniere commande:');
