...
define('TEXT_SALEMAKER_POPUP', '<a href="javascript:session_win();"><span class="errorText"><b>Cliquez ici pour des conseils sur l\'utilisation du Soldeur (SaleMaker).</b></span></a>');
...
define('TEXT_INFO_DELETE_INTRO', 'Êtes-vous certain(e) de vouloir supprimer définitivement cette solde ?');
define('TEXT_MORE_INFO', '(Plus d\'infos)');

define('TEXT_WARNING_SALEMAKER_PREVIOUS_CATEGORIES','&nbsp;ATTENTION : Cette catégorie fait déjà l\'objet de %s solde(s)');
?>