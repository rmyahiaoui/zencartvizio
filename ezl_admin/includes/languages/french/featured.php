...
define('WARNING_FEATURED_PRE_ADD_DUPLICATE', 'ATTENTION: ID# de produit déj&aacute; en vedette ... Rien n\'a été ajouté ...');
define('WARNING_FEATURED_PRE_ADD_BAD_PRODUCTS_ID', 'ATTENTION: ID# de produit invalide ... Rien n\'a été ajouté ...');
define('TEXT_INFO_HEADING_PRE_ADD_FEATURED', 'Ajouter manuellement un nouveau produit phare avec l\'ID# de produit');
define('TEXT_INFO_PRE_ADD_INTRO', 'Sur de grandes bases de données, vous pouvez ajouter manuellement un produit phare avec l\'ID# de produit<br /><br />C\'est le meilleur moyen de le faire lorsque la page prend trop de temps à se charger et que la sélection d\'un produit dans la liste déroulante devient difficile à cause du trop grand nombre de produits.');
define('TEXT_PRE_ADD_PRODUCTS_ID', 'Veuillez saisir l\'ID# de produit à pré-ajouter: ');
