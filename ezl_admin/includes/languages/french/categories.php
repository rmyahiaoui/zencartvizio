...
define('TEXT_DELETE_CATEGORY_INTRO_LINKED_PRODUCTS', '<strong>ATTENTION:</strong> Les produits liés dont les ID de catégorie maître sont supprimés n\'afficheront pas un prix correct. Vous devez vous assurer d\'abord lorsque vous supprimez une catégorie contenant des produits liés, que vous avez réinitialisé l\'ID de catégorie maître du(des) produit(s) à une autre catégorie avant d\'effacer la catégorie');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_INFO_CURRENT_PRODUCT', 'Produit en cours: ');
  ...
  define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_CATEGORY','Copier les attributs vers une autre <strong>catégorie</strong> depuis:<br />');
  ...
  define('TEXT_CATEGORIES_IMAGE_DIR','Uploader vers le répertoire:');
  define('TEXT_CATEGORIES_IMAGE_MANUAL', '<strong>Ou, choisissez une image existante sur le serveur, nom du fichier:</strong>');

  define('TEXT_VIRTUAL_PREVIEW','ATTENTION: Ce produit est marqué - Livraison gratuite et sauter l\'adresse de livraison');
  define('TEXT_VIRTUAL_EDIT','ATTENTION: Ce produit est marqué - Livraison gratuite et sauter l\'adresse de livraison');
  define('TEXT_FREE_SHIPPING_PREVIEW','ATTENTION: Ce produit est marqué - Livraison gratuite, adresse de livraison requise');
  define('TEXT_FREE_SHIPPING_EDIT','ATTENTION: Oui positionne le produit - Livraison gratuite, adresse de livraison requise');
  ...
  define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_PREVIEW','*Le prix affiché incluera le plus bas prix dans chaque groupe d\'attributs plus le prix');
  define('TEXT_PRODUCTS_PRICED_BY_ATTRIBUTES_EDIT','*Le prix affiché incluera le plus bas prix dans chaque groupe d\'attributs plus le prix');
  ...
  'Les <strong>produits virtuels</strong> n\'ont pas de frais de livraison et ne nécessitent pas d\'adresse de livraison comme les Services, ' . TEXT_GV_NAMES . ', etc.<br />' .
  ...
  'Les <strong>Downloads</strong> sont considérés comme des produits virtuels - Aucune option n\'a besoin d\'être marquée<br />'
  );
...
// categories status
define('TEXT_INFO_HEADING_STATUS_CATEGORY', 'Changer le statut de catégorie en:');
define('TEXT_CATEGORIES_STATUS_INTRO', 'Changer le statut de catégorie vers: ');
define('TEXT_CATEGORIES_STATUS_OFF', 'OFF');
define('TEXT_CATEGORIES_STATUS_ON', 'ON');
define('TEXT_PRODUCTS_STATUS_INFO', 'Changer TOUS les statuts de produit vers: ');
...
define('WARNING_PRODUCTS_IN_TOP_INFO', 'ATTENTION: Vous avez des produits dans la catégorie racine. Cela va fausser le fonctionnement des prix dans le catalogue. Produits trouvés: ');
