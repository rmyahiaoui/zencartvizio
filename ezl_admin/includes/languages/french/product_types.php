...
define('TEXT_HEADING_EDIT_PRODUCT_TYPE', 'Éditer le type de produit');
...
define('TEXT_PRODUCT_TYPES_URL', 'URL du fabricant:');

define('TEXT_DELETE_INTRO', 'Êtes-vous certain(e) de vouloir supprimer ce type de produit ?');
...
define('ERROR_DIRECTORY_NOT_WRITEABLE', 'ERREUR: Le répertoire cible n\'est pas inscriptible: %s');
